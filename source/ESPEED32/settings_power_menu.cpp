...
static void showVinCalibrationScreen() {
  ...
  const char* lblSet[9]    = {"SETT", "SET", "SET", "SET", "SET", "MAN", "SET", "SET", "SET"};
  const char* lblSave[9]   = {"TRYKK=LAGR", "CLICK=SAVE", "CLICK=SAVE", "CLICK=SAVE", "CLICK=SAVE", "CLICK=OK", "CLICK=SAVE", "KLIK=OPSL", "CLIQUE=GRAV"};
  const char* lblCancel[9] = {"BREMS=TILB", "BRAKE=BACK", "BRAKE=BACK", "BRAKE=BACK", "FRENO=ATR", "BREMS=ABBR", "FRENO=BACK", "REM=TERUG", "TRAV=VOLT"};
